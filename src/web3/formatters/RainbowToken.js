...
export default (methods, events) => ({
    ...
    events: {
        blendingPriceSet: () =>
            eventToEmitter(events.BlendingPriceSet({}, undefined)),
        tokenBlended: () => eventToEmitter(events.TokenBlended({}, undefined)),
        playerCreated: () =>
            eventToEmitter(events.PlayerCreated({}, undefined)),
        playerWon: () => eventToEmitter(events.PlayerWon({}, undefined))
    }
});
